...
public class DatabaseHelper : IDisposable
{
    ...
    public DatabaseHelper(string connectionstring, Providers provider)
    {
        ...
        switch (provider)
        {
            ...
            case Providers.ConfigDefined:
                string providername = ConfigurationManager.ConnectionStrings["DAEN690"].ProviderName;
                switch (providername)
                {
    ...
    public DatabaseHelper(Providers provider)
        : this(ConfigurationManager.ConnectionStrings["DAEN690"].ConnectionString, provider)
    {
    }
    ...
    public DatabaseHelper()
        : this(ConfigurationManager.ConnectionStrings["DAEN690"].ConnectionString, Providers.ConfigDefined)
    {
    }
